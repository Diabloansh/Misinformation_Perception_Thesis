...
def main():
    ...
    cmd = [sys.executable, 'src/evaluate.py', '--data_path', args.data, '--stage1_model', args.stage1_model, '--stage2_health_model', args.stage2_health_model, '--stage2_tech_model', args.stage2_tech_model, '--output_dir', args.output_dir]
    print('=' * 60)

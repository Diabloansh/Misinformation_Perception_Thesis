...
def main():
    ...
    stage2_health_model, stage2_health_config, stage2_health_tokenizer = load_model(args.stage2_health_model, device)
    stage2_tech_model, stage2_tech_config, stage2_tech_tokenizer = load_model(args.stage2_tech_model, device)
    ...
    if topic_name == 'health':
        route_probs = predict_single(args.text, stage2_health_model, stage2_health_tokenizer, stage2_health_config, device)
        route_config = stage2_health_config
    else:
        route_probs = predict_single(args.text, stage2_tech_model, stage2_tech_tokenizer, stage2_tech_config, device)

...
def main():
    ...
    cmd_parts = [sys.executable, 'src/train.py', '--data_path', args.data, '--output_dir', args.output_dir, '--epochs', str(args.epochs), '--batch_size', str(args.batch_size), '--learning_rate', str(args.learning_rate), '--patience', str(args.patience)]
    if args.test_data:

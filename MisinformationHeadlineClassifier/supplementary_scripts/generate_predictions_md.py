...
sys.path.insert(0, os.path.join(CLEAN_ROOT, 'hierarchical_model', 'src'))
...
def main():
    ...
    default_results = os.path.join(CLEAN_ROOT, 'hierarchical_model', 'results_hierarchical')
    parser.add_argument('--stage1-model', default=os.path.join(default_results, 'stage1', 'best_model.pt'), help='Path to stage1 best_model.pt')
    parser.add_argument('--stage2-health-model', default=os.path.join(default_results, 'stage2_health', 'best_model.pt'), help='Path to stage2 health best_model.pt')
    parser.add_argument('--stage2-tech-model', default=os.path.join(default_results, 'stage2_technology', 'best_model.pt'), help='Path to stage2 technology best_model.pt')
